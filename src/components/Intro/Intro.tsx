...
const Intro = ({onClick, isDark} : IntroProps) => {
  return (
    <Container
      title='Cómo jugar'
      textButton='!JUGAR¡'
      onClick={onClick}>
        <>
          ...
          <h3>Ejemplos:</h3>
          <div className='grid'>
            <ItemLetter isDark={isDark} letter='v'/>
            <ItemLetter isDark={isDark} letter='o'/>
            <ItemLetter isDark={isDark} status='warning' letter='c'/>
            <ItemLetter isDark={isDark} letter='a'/>
            <ItemLetter isDark={isDark} letter='l'/>
          </div>
          <p>La letra <strong>C</strong> está en la palabra pero en la posición incorrecta.</p>
          <h3>Ejemplos:</h3>
          <div className='grid'>
            <ItemLetter isDark={isDark} letter='c'/>
            <ItemLetter isDark={isDark} letter='a'/>
            <ItemLetter isDark={isDark} letter='n'/>
            <ItemLetter isDark={isDark} letter='t'/>
            <ItemLetter isDark={isDark} status='fail' letter='o'/>
          </div>
